...
#include <Aurora.Graphic/None/Driver.hpp>
    ...
    #include <Aurora.Graphic/Direct3D11/Driver.hpp>
...
namespace Graphic
{
    ...
    Bool Service::Initialize(Backend Backend, UInt Display, UInt16 Width, UInt16 Height)
    {
        ...
        if (!mDriver)
        {
            ...
            Successful = mDriver && mDriver->Initialize(Display, Width, Height);
    ...
    Object Service::CreatePass(UInt Display, UInt16 Width, UInt16 Height)
    {
