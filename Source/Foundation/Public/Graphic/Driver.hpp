...
namespace Graphic
{
    ...
    public:
        ...
        // -=(Undocumented)=-
        virtual void Initialise(Any Display, UInt Width, UInt Height) = 0;
        ...
        // -=(Undocumented)=-
        virtual void CreatePipeline(UInt ID, CPtr<UInt08> Vertex, CPtr<UInt08> Pixel, Ref<const Descriptor> Properties) = 0;
