...
inline namespace Core
{
    ...
    {
        const auto Iterator = eastl::find_if(mSpaces.begin(), mSpaces.end(), [Width, Height](Ref<const Rectangle> Space) {
    ...
    void Packer::Remove(Ref<const Recti> Rect)
    {
        ...
        Ref<Rectangle> Space = mSpaces.emplace_back(Rect.GetX(), Rect.GetY(), Rect.GetWidth(), Rect.GetHeight());
        ...
        auto OtherSpaceIterator = eastl::find_if(mSpaces.begin(), mSpaces.end(), [&](Ref<const Rectangle> Other) {
            return Other.X == Space.X + Space.Width && Other.Y == Space.Y && Other.Height == Space.Height;
        });
        ...
        OtherSpaceIterator = eastl::find_if(mSpaces.begin(), mSpaces.end(), [&](Ref<const Rectangle> Other) {
            return Other.X == Space.X && Other.Y == Space.Y + Space.Height && Other.Width == Space.Width;
        });
