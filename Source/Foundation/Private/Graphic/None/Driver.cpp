...
namespace Graphic
{
    ...
    void NoneDriver::UpdateTexture(UInt ID, UInt Level, Rect Offset, UInt Pitch, CPtr<UInt08> Data)
    {
    }
    ...
    void NoneDriver::Prepare(UInt ID, Rect Viewport, Clear Target, Color Tint, Real32 Depth, UInt08 Stencil)
    {
    }
