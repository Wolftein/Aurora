...
inline namespace COM
{
    ...
    HRESULT Audio_Service::FinalRelease()
    {
        mWrapper = nullptr;
        return S_OK;
    }
    ...
    {
        mWrapper->SetListener(Vector3f(X, Y, Z), Vector4f(0, 0, 0, 0)); // TODO
        return S_OK;
    }
    ...
    {
        (*Instance) = mWrapper->Play(Submix, CCast<Audio_Sound>(Sound), CCast<Audio_Emitter>(Emitter), VBIsTrue(Repeat));
        return S_OK;
    }
