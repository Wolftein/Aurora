...
namespace Network
{
    ...
    SPtr<Server> EnetDriver::Listen(Ref<Protocol> Protocol, CStr Address, UInt16 Port, UInt32 Capacity)
    {
    ...
    SPtr<Client> EnetDriver::Connect(Ref<Protocol> Protocol, CStr Address, UInt16 Port)
    {
